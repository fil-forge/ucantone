...
// SETTINGS_MAX_CONCURRENT_STREAMS; x/net/http2 defaults to 250. Nobody
// documents a derivation for these numbers: they bound how much one peer can
// have in flight while leaving batches of everyday size unthrottled.
...
// HTTP/2 or QUIC server caps concurrent streams per connection. Zero removes
// the cap, for deployments that bound concurrency at the listener instead.
// A negative value panics. Defaults to [DefaultMaxConcurrency].
